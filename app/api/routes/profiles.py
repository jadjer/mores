...
async def get_my_profile(
    ...
    request_error = HTTPException(status_code=status.HTTP_409_CONFLICT, detail=strings.EVENT_ALREADY_EXISTS)
...
async def update_profile(
    ...
    profile = await profiles_repo.update_profile(user=current_user, **profile_update.__dict__)
